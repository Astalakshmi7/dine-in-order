...
public class ResponseBuilder {
     ...
     */
    public static <T> ResponseEntity<ResponseStruture<T>> created(String message, T data) {
     ...
     */
    public static <T> ResponseEntity<ResponseStruture<T>> ok(String message, T data) {
